...
(function (root, factory) {
  ...
  var DateRangePicker = function (element, options, cb) {
    ...
    if (typeof options.singleClasses === "string") this.singleClasses = options.singleClasses;

    if (typeof options.singleClasses === "object") this.singleClasses = options.singleClasses.join(" ");
