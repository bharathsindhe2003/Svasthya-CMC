...
function init_echarts() {
  $(document).ready(() => {
    ...
    if (id && id != null && id != undefined) {
      ...
      ecg_min = fb.database().ref().child("patientecgdata").child(id).orderByKey().limitToLast(1);
      ppg_min = fb.database().ref().child("patientppgdata").child(id).orderByKey().limitToLast(1);
      rr_min = fb.database().ref().child("patientrrdata").child(id).orderByKey().limitToLast(1);
